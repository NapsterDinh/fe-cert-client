  ...
  return (
    <>
      <Radio.Group
        ...
        buttonStyle="solid"
      >
        <div class="tab3-title">Original practice test</div>
        <div>
          <Radio value={1}>Option A</Radio>
          <Radio value={2}>Option B</Radio>
          <Radio value={3}>Option C</Radio>
        </div>
        <div class="tab3-title">This exam question</div>
        <div>
          <Radio value={4}>Option A</Radio>
          <Radio value={5}>Option B</Radio>
          <Radio value={6}>Option C</Radio>
        </div>
        <div class="tab3-title">Old examination system</div>
        <div>
      ...
      <div className="text-center mb-4 my-4">
        <Button variant="primary" className="make-full" onClick={startPraticing}>
          Start practicing
        </Button>
      </div>
    </>
