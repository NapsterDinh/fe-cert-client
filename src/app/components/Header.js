...
import { Form, Dropdown, ListGroup,
  Navbar, InputGroup, Nav, Image, Button } from '@themesberg/react-bootstrap';
      ...
      <div className="container-header">
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="me-auto">
            ...
            <NavLink to={'/exams/fe-exam1-morning-session'} className='nav-link' activeClassName="active">Exam</NavLink>
          </Nav>
          <Nav>
